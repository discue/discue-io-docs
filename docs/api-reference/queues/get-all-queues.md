...
```shell
curl -X GET http://api.discue.io/v1/queues \
...
r = requests.get('http://api.discue.io/v1/queues', headers = headers)
```
...
func main() {
  ...
  req, err := http.NewRequest("GET", "http://api.discue.io/v1/queues", data)
  req.Header = headers
...
```json
{
  ...
  "_links": {
    "self": {
      "href": "https://api.discue.io/queues"
    },
    "myapp.io/delete-user-queue": {
...
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Ok|[GetQueuesResponse](#getqueuesresponse)|
